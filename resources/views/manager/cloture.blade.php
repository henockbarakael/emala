                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered review-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{$solde_theorique}} Fc</td>
                                    <td class="text-right">{{$solde_theorique_2}} $</td>
                                    <td>{{$report_nouveau}} Fc</td>
                                    <td class="text-right">{{$report_nouveau_2}} $</td>
                                    <td>{{$fond_ajoute}} Fc</td>
                                    <td class="text-right">{{$fond_ajoute_2}} $</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <table class="table table-bordered review-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center"><input id="transfert_fc" oninput="add_number()" type="text"  class="form-control"></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered review-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-left" style="font-size: 14px; text-transform:uppercase;"><b>Transfert en banque</b></td>
                                        <td colspan="1" class="text-center"><input id="transfert_usd" oninput="add()" type="text"  class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"  class="text-left" style="font-size: 14px; text-transform:uppercase;"><b>Montant à reporter</b></td>
