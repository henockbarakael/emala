...
@section('content')
@section('title','Gestion de l\'agence')
@section('page','Comptes agence')
{!! Toastr::message() !!}
  <div class="page-body">
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($users as $key => $value)
                  <tr>
                    ...
                    <td class="agence">{{$value->bname}}</td>
                    ...
                    <td class="text-center"><button class="btn btn-primary btn-xs AccountTopUp" title="Recharge Account" data-bs-toggle="modal" data-original-title="test" data-bs-target="#topup">Demande</button></td>
                    {{-- <td class="text-center">
                        <a href="" class="btn btn-primary btn-xs userUpdate" title="Edit manager" data-bs-toggle="modal" data-original-title="test" data-bs-target="#edit_user"><i class="fa fa-edit"></i></a>
                        <a href="" class="btn btn-secondary btn-xs userDelete" title="Delete manager" data-bs-toggle="modal" data-original-title="test" data-bs-target="#delete_user"><i class="icofont icofont-ui-delete"></i></a>
                    </td> --}}
                  </tr>
                @endforeach
                </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel2">Créer un ticket</h5>
        </div>
        <div class="modal-body">
            <form action="{{route('cashier.reharge.request.store')}}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-12 mt-4">
                        <label class="form-label" for="validationCustom01">Objet de la requêtte</label>
                        <input readonly class="form-control input-air-primary @error('subject') is-invalid @enderror" placeholder="Demande d'approvisionnemant" name="subject" id="e_subject" type="text" value="Demande d'approvisionnemant" >
                        @error('subject')
                  ...
                  <div class="col-md-12 mt-4">
                    ...
                    <select name="assigned_id" class="form-select input-air-primary digits @error('assigned_id') is-invalid @enderror" id="exampleFormControlSelect9">
                      <option  selected disabled>Choisir un manageristrateur</option>
                      @foreach($admins as $manager)
