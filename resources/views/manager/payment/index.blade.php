...
@section('content')
@section('title','Toutes les demandes de paiement')
@section('page','Demandes de paiement')
{!! Toastr::message() !!}
  <div class="page-body">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5>Toutes les demandes de paiement</h5>
          </div>
          <div class="card-body">
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($transactions as $key => $value)
                  ...
                  <tr>
                    ...
                    {{-- <td class="type text-left"><a href="{{ url('admin/historique/profil-client/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td> --}}
