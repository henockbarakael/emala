      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <form class="row date-range-picker" action="{{route('manager.transaction.recherche')}}" method="POST">
              @csrf
              <div class="col-xl-3">
              ...
              <table class="display" id="basic-8">
                ...
                @endphp
                  <tr>
                    ...
                    @else
                    <td class="sender text-left"><a href="{{ url('manager/compte-client-phone/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td>
                    @endif
                    ...
                    @else
                    <td class="receiver text-left"><a href="{{ url('manager/compte-client-phone/'.Crypt::encrypt($value->receiver_phone)) }}">{{$value->receiver_phone}}</a></td>
                    @endif
