                              ...
                              <table class="display" id="orderingById">
                                ...
                                @endphp
                                  <tr>
                                    ...
                                    <td class="type text-left"><a href="{{ url('cashier/compte-client-phone/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td>
                                    ...
                                    <td class="type text-left"><a href="{{ url('cashier/compte-client-phone/'.Crypt::encrypt($value->receiver_phone)) }}">{{$value->receiver_phone}}</a></td>
