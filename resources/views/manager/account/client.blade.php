                  ...
                  {{-- <div class="col-sm-12">
                    <div class="card ">
                      <div class="card-body" style="background-image: linear-gradient(to right, #295f12 0%, #34641f 51%, #123304 100%);">                     
                        ...
                        <div class="row g-3 ">
                          <div class="col-md-3">
                            <a href="{{ url('manager/transfert/interne/'.Crypt::encrypt($id_user))}}" class="btn btn-success" id="addDefault">Transfert</a>
                          </div>
                          <div class="col-md-3">
                            <a href="{{ url('manager/retrait/cash/'.Crypt::encrypt($id_user)) }}" class="btn btn-success" id="addToDo">Retrait Emala</a>
                          </div>
                          <div class="col-md-3">
                            <a href="{{ url('manager/depot/cash/'.Crypt::encrypt($id_user)) }}" class="btn btn-success" id="removeBoard">Dépôt Emala</a>
                          </div>
                          <div class="col-md-3">
                            <a href="{{ url('manager/mobile-money/interne/'.Crypt::encrypt($id_user)) }}" class="btn btn-success" id="removeBoard">Mobile money</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-3 chart_data_right box-col-3">
                    <div class="card">
                      <div class="card-body" style="padding: 10px">
                        <div class="media align-items-center">
                          <div class="media-body right-chart-content">
                            <a style="width: 100%" href="{{ url('manager/mobile-money/interne/'.Crypt::encrypt($id_user)) }}" class="btn btn-success" id="removeBoard">Mobile money</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-6 chart_data_right box-col-6">
                    <div class="card">
                      <div class="card-body" style="padding: 10px">
                        <div class="media align-items-center">
                          <div class="media-body right-chart-content">
                            <a style="width: 100%" href="{{ url('manager/transfert/compte-compte/'.Crypt::encrypt($id_user)) }}" class="btn btn-danger" id="removeBoard">Transfert compte à compte</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-6 chart_data_right box-col-6">
                    <div class="card">
                      <div class="card-body" style="padding: 10px">
                        <div class="media align-items-center">
                          <div class="media-body right-chart-content">
                            <a style="width: 100%" href="{{ url('manager/retrait/compte-epargne/'.Crypt::encrypt($id_user)) }}" class="btn btn-primary" id="removeBoard">Retrait compte epargne</a>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <table class="display" id="orderingById">
                            ...
                            @endphp
                              <tr>
                                ...
                                <td class="type text-center"><a href="{{ url('manager/compte-client-phone/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td>
                                ...
                                <td class="type text-center"><a href="{{ url('manager/compte-client-phone/'.Crypt::encrypt($value->receiver_phone)) }}">{{$value->receiver_phone}}</a></td>
