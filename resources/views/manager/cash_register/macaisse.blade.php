                ...
                <div class="table-responsive">
                  <table class="display" id="basic-8">
                    ...
                    @foreach ($transactions as $key => $value)
                      <tr>
                        <td class="wallet_id"><a href="{{ url('manager/historique/profil-client/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td>
                        ...
                        <td class="type text-center"><a href="{{ url('manager/historique/profil-client/'.Crypt::encrypt($value->receiver_phone)) }}">{{$value->receiver_phone}}</a></td>
