                ...
                <div class="card">
                    <div class="col-sm-12" style="padding: 10px">
                        <span class="pull-right">
                            <a href="{{route('manager.creation_marchand')}}" class="btn btn-success" type="button" data-bs-original-title="" title="">
      ...
      <div class="col-sm-12">
        <div class="card">
          {{-- <div class="card-header">
            ...
            <span class="pull-right">
              <a href="{{route('manager.user.create')}}" class="btn btn-primary" type="button" data-bs-original-title="" title="">
