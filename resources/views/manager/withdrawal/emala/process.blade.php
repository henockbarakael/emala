              ...
              <table class="display" id="basic-8">
                ...
                @endphp
                  <tr>
                    ...
                    {{-- <td class="type text-left"><a href="{{ url('manager/historique/profil-client/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td> --}}
                    ...
                    <td class="balance_usd text-left">{{$value->currency}}</td>
