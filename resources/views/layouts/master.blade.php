...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <script>
      function ajaxReq(){
        @if (Auth::user()->role_name == "Admin") 
          var url = '{{route("admin.ouverture_caisse")}}';
          var redirect = '{{route("admin.ouverture_caisse")}}';
        
        @elseif (Auth::user()->role_name == "Manager") 
          var url = '{{route("manager.ouverture_caisse")}}';
          var redirect = '{{route("manager.ouverture_caisse")}}';

        @elseif (Auth::user()->role_name == "Cashier") 
          var url = '{{route("cashier.ouverture_caisse")}}';
          var redirect = '{{route("cashier.ouverture_caisse")}}';
    ...
    <script>
      ...
      function closing(){
        @if (Auth::user()->role_name == "Admin") 
          var url = '{{route("admin.cloture_caisse")}}';
          var redirect = '';
        
        @elseif (Auth::user()->role_name == "Manager") 
          var url = '{{route("manager.cloture_caisse")}}';
          var redirect = '';

        @elseif (Auth::user()->role_name == "Cashier") 
          var url = '{{route("cashier.cloture_caisse")}}';
          var redirect = '';
