                  ...
                  <div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="card">
                          <div class="card-body">
                            {{-- <form class="needs-validation" action="{{ route('admin.payments.store', ['loanId' => $loan->id]) }}" method="POST"> --}}
                            <form class="needs-validation" action="{{ route('admin.loans.make-payment', ['id' => $loan->id]) }}" method="POST">
