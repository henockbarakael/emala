                ...
                <table class="display" id="basic-8">
                  <thead>
                    <tr>
                      ...
                      <th >Action sur la demande</th>
                    </tr>
                  </thead>
                  <tbody>
                    @foreach ($prets as $key => $value)
                      <tr>
                        <td class="control_number"><a href="{{ route('prets.show', ['id' => $value->id]) }}">{{ $value->control_number }}</a></td>
                        ...
                        <td class="action">
                          @if ($value->loan_status == 'Approuvé' || $value->loan_status == 'Rejeté')
                            <button class="btn btn-danger btn-xs annulerDemandeBtn" type="button" disabled>Refuser</button>
                            <button class="btn btn-success btn-xs validerDemandeBtn" type="button" disabled>Approuvé</button>
                          @else
                            <button class="btn btn-danger btn-xs annulerDemandeBtn" type="button" data-bs-toggle="modal" data-bs-target="#annulerModal{{$value->id}}" data-original-title="btn btn-danger btn-xs" title="">Refuser</button>
                            <button class="btn btn-success btn-xs validerDemandeBtn" type="button" data-bs-toggle="modal" data-bs-target="#validerModal{{$value->id}}" data-original-title="btn btn-danger btn-xs" title="">Approuvé</button>
                          @endif
                        </td>
                      </tr>
