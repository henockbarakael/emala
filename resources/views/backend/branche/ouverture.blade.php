            ...
            <div class="row">
                <div class="col-md-12 text-end pull-right">
                    <div class="select2-drpdwn-product select-options d-inline-block">
                        ...
                        @else
                        <a href="{{route('admin.cloture_caisse')}}" class="btn btn-danger shadow shadow-showcase" type="button">CLÔTURER CAISSE</a>
                        @endif
                    </div>
                </div>
            </div>
        </div>
        {{-- @if (!empty(Session::get('success')) && Session::get('success') == false)
            <script>
              $(function(){
                    ...
                    <table class="display shadow shadow-showcase table-bordered" id="basic-8">
                      ...
                      @endphp
                        <tr>
                          ...
                          <td class="sender text-left"><a href="{{ url('admin/compte-client/'.Crypt::encrypt($value->id)) }}">{{$value->sender_phone}}</a></td>
                          ...
                          <td class="receiver text-left"><a href="{{ url('admin/compte-client/'.Crypt::encrypt($value->id)) }}">{{$value->receiver_phone}}</a></td>
