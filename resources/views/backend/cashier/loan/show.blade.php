...
<head>
    ...
    <title>Calendrier d'amortissement</title>
...
@endpush
@section('content')
@section('page','Calendrier d\'amortissement')
@section('page_1','Amortissement prêt')
@section('page_2','Calendrier d\'amortissement')
{!! Toastr::message() !!}
  <div class="page-body">
