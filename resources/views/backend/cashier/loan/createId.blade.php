                  ...
                  <div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form  action="{{route('cashier.loans.store')}}" method="POST">
                                @csrf
                                <div class="row g-3">
                                  <div class="col-md-4 mt-2">
                                    <label class="form-label" for="validationCustom01">Téléphone Bénéficiaire</label>
                                    <input  readonly class="form-control input-air-primary @error('phone') is-invalid @enderror" value="{{$data['phone_number']}}" name="phone" id="phone" type="text" required="">
                                    {{-- <ul id="userList"></ul> --}}
                                    @error('phone')
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly  class="form-control input-air-primary @error('surname') is-invalid @enderror" name="surname"  value="{{$data['firstname']}}" id="surname" type="text" required="">
                                    @error('surname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly  class="form-control input-air-primary @error('name') is-invalid @enderror" name="name"  value="{{$data['lastname']}}" id="name" type="text" required="">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
