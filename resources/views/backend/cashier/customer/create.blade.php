    ...
    <div class="container-fluid">
        ...
        <div class="row mt-2 mb-4">
          <div style="height: 30px">
            <a href="{{route('cashier.customer.all')}}" class="btn btn-success btn-sm pull-right" ><span><i class="fa fa-plus text-white"></i></span> Liste des clients</a>
          </div>
      </div>
