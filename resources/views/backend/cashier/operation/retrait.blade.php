                  ...
                  <div>
                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              <h4 style="font-size: 12px" class="media-heading">Retrait d'argent</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('cashier.customer.processWithdraw')}}" method="POST">
                                @csrf
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('phone') is-invalid @enderror" value="{{$phone_number}}" name="phone" id="phone" type="text" required="">
                                    @error('phone')
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('surname') is-invalid @enderror" name="surname"  value="{{$firstname}}" id="surname" type="text" required="">
                                    @error('surname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('name') is-invalid @enderror" name="name"  value="{{$lastname}}" id="name" type="text" required="">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <button class="col-sm-12 btn btn-primary mt-3" type="submit">Valider</button>
                              </form>
                            </div>
                          </div>
...
<script type="text/javascript">
  ...
  function calculateFees() {
      ...
      if (compte.value === "saving") {
          pourcentage = 3; // 3% pour le compte "saving"
      } else {
          pourcentage = 1; // 1% pour le compte "current"
      }
