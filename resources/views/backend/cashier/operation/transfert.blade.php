                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              <h4 style="font-size: 12px" class="media-heading">Transfert compte à ompte</h4>
                              ...
                              <form class="needs-validation" action="{{route('cashier.customer.processTransfer')}}" method="POST">
                                ...
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('sender_phone') is-invalid @enderror" value="{{$phone_number}}" name="sender_phone" id="sender_phone" type="text" required="">
                                    @error('sender_phone')
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('sender_first') is-invalid @enderror" name="sender_first"  value="{{$firstname}}" id="sender_first" type="text" required="">
                                    @error('sender_first')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                  ...
                                  <div class="col-md-4 mt-2">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('sender_last') is-invalid @enderror" name="sender_last"  value="{{$lastname}}" id="sender_last" type="text" required="">
                                    @error('sender_last')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                  ...
                                  {{-- <div class="col-md-12 mt-4">
                                    ...
                                    <select name="receiver_number" class="form-select input-air-primary digits @error('receiver_number') is-invalid @enderror" id="exampleFormControlSelect9">
                                      ...
                                      @foreach ($receiver as $users )
                                        <option value="{{ $users->phone }}">{{ $users->firstname." ".$users->lastname." - ".$users->phone        }}</option>
                                      @endforeach
                                    </select>
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <select name="compte" class="form-select input-air-primary digits @error('compte') is-invalid @enderror">
                                      <option selected disabled>Choisir le compte</option>
                                      <option value="current">Compte Principal</option>
                                      <option value="saving">Compte Epargne</option>
                                    </select>
