...
{!! Toastr::message() !!}
            ...
            <div class="card">
                <div class="col-sm-12" style="padding: 10px">
                    <span class="pull-right">
                        ...
                        <span><i class="fa fa-plus text-white"></i></span> Ajouter un admin
                        </a>
                    </span>
                </div>
            </div>
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($users as $key => $value)
                  <tr>
                    ...
                    <td hidden class="password">{{$value->password_salt}}</td>
                    ...
                    <td class="phone_number"><a href="{{url('admin/profil-utilisateur/'.Crypt::encrypt($value->phone_number))}}">{{$value->phone_number}}</a></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel2">Ajouter un admin</h5>
        </div>
        <div class="modal-body">
            <form action="{{route('admin.creation_admin')}}" method="POST">
                @csrf
  ...
  <div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel2">Modifier admin</h5>
        </div>
        <div class="modal-body">
            <form action="{{route('admin.modification_admin')}}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control input-air-primary @error('password') is-invalid @enderror" name="password" id="e_password" type="text" value="" >
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
  ...
  <div class="modal fade" id="delete_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-btn">
            <form action="{{route('admin.supprimer_admin')}}" method="POST">
                @csrf
  ...
  @section('script')
    ...
    <script>
        $(document).on('click','.userUpdate',function()
        {
            ...
            $('#e_password').val(_this.find('.password').text());
        });
    </script>
    {{-- delete js --}}
    <script>
