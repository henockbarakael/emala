              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($customers as $key => $value)
                  <tr>
                    ...
                    <td class="phone_number"><a href="{{ url('admin/compte-client/'.Crypt::encrypt($value->id)) }}">{{$value->phone}}</a></td>
                    <td hidden class="pays">{{$value->password_salt}}</td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('admin.creation_client')}}" method="POST">
                @csrf
  ...
  <div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('admin.modification_client')}}" method="POST">
                @csrf
  ...
  <div class="modal fade" id="delete_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-btn">
            <form action="{{route('admin.supprimer_client')}}" method="POST">
                @csrf
