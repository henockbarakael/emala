                ...
                <tbody>
                  @foreach ($transactions as  $key => $value)
                    <tr>
                      ...
                      <td class="text-left"><a href="{{ url('manager/compte-client-phone/'.Crypt::encrypt($value->sender_phone)) }}">{{$value->sender_phone}}</a></td>
                      <td>{{$value->amount}}</td>
                      <td>{{$value->currency}}</td>
                      <td><a href="{{ url('manager/compte-client-phone/'.Crypt::encrypt($value->receiver_phone)) }}">{{$value->receiver_phone}}</a></td>
                      <td>{{$value->fees}}</td>
