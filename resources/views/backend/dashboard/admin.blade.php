          ...
          <div class="card">
            <div class="card-body row">
              ...
              <div class="col-xl-3 col-sm-3 box-col-3">
                <div class="myshadow p-25 text-center text-white" style="background-color: #119e3e;">
                  <span>EMALA USD</span>
                  <h5 class="m-0 f-18">{{ $balanceUSD }}</h5>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-sm-3 box-col-3 ">
                <div class="myshadow p-25 text-center text-white" style="background-color: #119e3e;">
                  <span>TSHUMBE CDF</span>
                  <h5 class="m-0 f-18">{{ $soldeGlobalCDF }}</h5>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-sm-3 box-col-3">
                <div class="myshadow p-25 text-center text-white" style="background-color: #119e3e;">
                  <span>TSHUMBE USD</span>
                  <h5 class="m-0 f-18">{{ $soldeGlobalUSD }}</h5>
                </div>
              </div>
            ...
            <div class="card-block row">
              <div class="col-sm-12 col-lg-12 col-xl-12">
                <div class="table-responsive table-border">
                  <table class="table table-styling table-bordered table-hover table-striped">
                    <thead>
                      <tr>
                        <th scope="col">#</th>
