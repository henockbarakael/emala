              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($wallets as $key => $value)
                  <tr>
                    ...
                    <td class="account_id text-center">{{$value->account_id}}</td>
                    ...
                    <td>
                        <a href="{{ url('gerant/recharge-compte/'.Crypt::encrypt($value->id)) }}" class="btn btn-primary btn-xs userUpdate" title="Edit admin" data-bs-toggle="modal" data-original-title="test" data-bs-target="#edit_user">Top Up</a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('root.wallet.topup')}}" method="POST">
                @csrf
