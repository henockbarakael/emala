      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5 style="text-transform: none">Liste des clients</h5>
          </div>
          <div class="card-body">
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($accounts as $key => $value)
                  <tr>
                    ...
                    <td class="contact">{{$value->phone_number}}</td>
                    <td class="acnumber text-left">{{$value->acnumber}}</td>
                    <td class="acnumber text-center">{{$value->balance_cdf}}</td>
                    <td class="acnumber text-center">{{$value->balance_usd}}</td>
                    <td class="actype text-center">                        
                        <a href="{{ url('admin/transfert/interne/wallet-to-mobile/'.Crypt::encrypt($value->acnumber)) }}" class="btn btn-success btn-sm">Envoyer</a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
