      ...
      <div class="row">
        ...
        <div class="card-body">
            ...
            <span class="pull-right">
              <a href="{{route('admin.customer.create')}}" class="btn btn-primary" type="button" data-bs-original-title="" title="">
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($customers as $key => $value)
                  <tr>
                    ...
                    <td class="phone_number"><a href="{{ url('admin/profil-client/'.Crypt::encrypt($value->id)) }}">{{$value->phone_number}}</a></td>
