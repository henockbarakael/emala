    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Gestion de caisse</li>
                            <li class="breadcrumb-item active">Détail du compte</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">{{ $users->firstname." ".$users->name }}</h3>
                                                <h6 class="text-muted">{{ $users->role_name }} Client Emala</h6>
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"><a href="#courant" data-toggle="tab" class="nav-link active">Compte courant</a></li>
                            <li class="nav-item"><a href="#epargne" data-toggle="tab" class="nav-link">Compte epargne</a></li>
                            <li class="nav-item"><a href="#historique" data-toggle="tab" class="nav-link">Historique des transaction</a></li>
            ...
            <div class="tab-content">
                <!-- Profile Info Tab -->
                <div id="courant" class="pro-overview tab-pane fade show active">
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title"><span style="font-family: ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;"> N° COMPTE : {{$courant_cdf->compte_id}}</span></h3>
                ...
                <div id="epargne" class="pro-overview tab-pane fade show">
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title"><span style="font-family: ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;"> N° COMPTE : {{$epargne_cdf->compte_id}}</span></h3>
                                    <section class="dash-section">
                                        <div class="dash-sec-content">
                                            <div class="dash-info-list">
                                                <div class="dash-card">
                ...
                <div id="historique" class="pro-overview tab-pane fade show">
                    <div class="row">
