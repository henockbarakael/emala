              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($tickets as $key => $value)
                  <tr>
                    ...
                    <td class="brancheId">{{$value->bcode}}</td>
  ...
  <div class="modal fade" id="failed" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-btn">
            <form action="{{route('admin.reharge.request.failed')}}" method="POST">
                @csrf
  ...
  <div class="modal fade" id="success" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-btn">
            <form action="{{route('admin.reharge.request.success')}}" method="POST">
                @csrf
