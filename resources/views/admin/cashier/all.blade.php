      ...
      <div class="row">
        ...
        <div class="card-body">
            ...
            <span class="pull-right">
              <a href="{{route('admin.branche.cashier.create')}}" class="btn btn-primary" type="button" data-bs-original-title="" title="">
                <span><i class="fa fa-plus text-white"></i></span> Ajouter un caissier
              </a>
            </span>
          </div>
        </div>
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($cashiers as $key => $value)
                  <tr>
                    ...
                    <td class="phone_number"><a href="{{ url('admin/profil-utilisateur/'.Crypt::encrypt($value->id)) }}">{{$value->phone_number}}</a></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel2">Modifier Caissier</h5>
        </div>
        <div class="modal-body">
            <form action="{{route('admin.branche.cashier.update')}}" method="POST">
                @csrf
