...
@section('page','Listes_des_agences')
{!! Toastr::message() !!}
  <div class="page-body">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5 style="text-transform: none">Liste des agences</h5>
          </div>
          <div class="card-body">
              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($branches as $key => $value)
                  <tr>
                    ...
                    <td hidden class="bank_user_id">{{$value->bank_user_id}}</td>
                    ...
                    <td class="btn text-center topupBranche" data-bs-toggle="modal" data-original-title="test" data-bs-target="#topup"><span class="badge badge-light-success" style="text-decoration: none">Topup wallet</span></td>
                    <td class="text-right ">
                        <a href="" class="btn btn-succes btn-xs userUpdate" title="Modifier" data-bs-toggle="modal" data-original-title="test" data-bs-target="#edit_user"><i class="fa fa-edit"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('admin.branche.topup') }}" method="POST">
                @csrf
                <input hidden type="hidden" name="bank_user_id" id="e_bank_user_id" value="">
                <div class="row g-3">
                  <div class="col-md-6">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('admin.branche.update')}}" method="POST">
                @csrf
                <input hidden type="hidden" name="id" id="e_id" value="">
                <div class="row g-3">
                  <div class="col-md-6">
  ...
  @section('script')
    ...
    <script>
      $(document).on('click','.topupBranche',function()
      {
          var _this = $(this).parents('tr');
          $('#e_bank_user_id').val(_this.find('.bank_user_id').text());
