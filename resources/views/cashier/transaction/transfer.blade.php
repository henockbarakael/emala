              ...
              <table class="display" id="basic-8">
                ...
                @endphp
                  <tr>
                    ...
                    @else
                    <td class="sender text-left"><a href="{{ url('cashier/compte-client-phone/'.Crypt::encrypt($value->id)) }}">{{$value->sender_phone}}</a></td>
                    @endif
                    ...
                    @else
                    <td class="receiver text-left"><a href="{{ url('cashier/compte-client-phone/'.Crypt::encrypt($value->id)) }}">{{$value->receiver_phone}}</a></td>
                    @endif
