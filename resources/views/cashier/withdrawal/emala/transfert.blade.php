                  ...
                  <div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('cashier.withdrawal.transfert.store')}}" method="POST">
                                @csrf
                                <div class="row g-3">

                                  <div class="col-md-6 mt-4">
                                    <label class="form-label" for="validationCustom01">Code de la transaction</label>
                                    <input class="form-control input-air-primary @error('reference') is-invalid @enderror" name="reference" id="reference" type="text"  required="">
                                    @error('reference')
