...
@section('content')
@section('title','Transaction - Retrait Wallet To Cash')
@section('page','Transaction - Retrait Wallet To Cash')
{!! Toastr::message() !!}
  <div class="page-body">
                  ...
                  <div>
                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              <h4 class="media-heading">Retrait Wallet To Cash</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('cashier.withdrawal.compte.store')}}" method="POST">
                                @csrf
                                <div class="row g-3">
