              ...
              <table class="display" id="basic-8">
                ...
                @foreach ($customers as $key => $value)
                  <tr>
                    ...
                    <td class="phone_number"><a href="{{ url('cashier/compte-client/'.Crypt::encrypt($value->id)) }}">{{$value->phone}}</a></td>
                    <td hidden class="pays">{{$value->country}}</td>
                    <td class="status"><div class="badge badge-light-success">{{$value->status}}</div></td>
                    <td>
                        <a href="" class="btn btn-success btn-xs userUpdate" title="Edit cashier" data-bs-toggle="modal" data-original-title="test" data-bs-target="#edit_user"><i class="fa fa-edit"></i></a>
                        <a href="" class="btn btn-danger btn-xs userDelete" title="Delete cashier" data-bs-toggle="modal" data-original-title="test" data-bs-target="#delete_user"><i class="icofont icofont-ui-delete"></i></a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('cashier.creation_client')}}" method="POST">
                @csrf
  ...
  <div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('cashier.modification_client')}}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <label class="form-label" for="validationCustom01">Téléphone</label>
                    <input class="form-control input-air-primary @error('phone_number') is-invalid @enderror" name="phone_number" id="e_telephone" type="tel" value="" >
                    @error('phone_number')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
  ...
  <div class="modal fade" id="delete_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-btn">
            <form action="{{route('cashier.supprimer_client')}}" method="POST">
                @csrf
