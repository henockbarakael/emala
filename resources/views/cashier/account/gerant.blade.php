                  ...
                  <div class="col-12 ">
                    ...
                    <div class="card ">
                      <div class="card-body" style="background-image: linear-gradient(to right, #295f12 0%, #34641f 51%, #123304 100%);">                    
                        ...
                        <div class="row g-3 ">
                          <div class="col-md-3">
                            <a href="{{ url('cashier/transfert/interne/'.Crypt::encrypt($user_id))}}" class="btn btn-success" id="addDefault">Approvisionner</a>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="follow">
                            <div class="row">
                              <div class="col-12 text-center border-right">
                                <div class="follow-num counter">{{$current_wallet_code}}</div>
                                <span>Balance usd : {{$current_balance_usd}}</span> ||
                                <span>Balance cdf : {{$current_balance_cdf}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
