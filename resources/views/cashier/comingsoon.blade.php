...
<html lang="en">
  <head>
    ...
    <title>Emala Fintech</title>
    <!-- Google font-->
    <link href="{{ asset('css?family=Rubik:400,400i,500,500i,700,700i&amp;display=swap')}}" rel="stylesheet">
    <link href="{{ asset('css-1?family=Roboto:300,300i,400,400i,500,500i,700,700i,900&amp;display=swap')}}" rel="stylesheet">
