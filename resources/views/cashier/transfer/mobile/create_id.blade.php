...
@section('page','Transfert - Mobile Money')
{!! Toastr::message() !!}
  <div class="page-body">
                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              <h4 class="media-heading">Transfert d'Argent</h4>
                              <p>Entrez le numéro de téléphone du client, puis ajoutez un montant avec la devise pour envoyer de l'argent via Mpesa, Orange money et Airtel money en toute sécurité.<br><span></span></p>
                            </div>
                          </div>
                          <!-- End Info-->
                        </div>
                              ...
                              <form class="needs-validation" action="" method="POST">
                                ...
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-6 mt-4">
                                    ...
                                    <input readonly class="form-control input-air-primary @error('customer_number') is-invalid @enderror" name="customer_number" id="customer_number" value="{{$user->phone}}" type="text"  required="">
