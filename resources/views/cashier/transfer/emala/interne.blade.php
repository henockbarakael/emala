                  ...
                  <div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('cashier.transfer.emala_interne.store')}}" method="POST">
                                @csrf
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-12 mt-4">
                                    <label class="form-label" for="validationCustom01">Numéro Client</label>
                                  ...
                                  <div class="col-md-6 mt-4">
                                    <label class="form-label" for="compte">Choisir un compte</label>
