...
@section('content')
@section('title','Transaction - Dépôt Interne')
@section('page','Transaction - Dépôt Interne')
{!! Toastr::message() !!}
  <div class="page-body">
                  ...
                  <div>
                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              <h4 class="media-heading">Dépôt Interne</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('cashier.internal.deposit')}}" method="POST">
                                @csrf
                                <div class="row g-3">
