...
@section('content')
@section('title','Transaction - Dépôt Externe')
@section('page','Transaction - Dépôt Externe')
{!! Toastr::message() !!}
  <div class="page-body">
                  ...
                  <div>
                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              <h4 class="media-heading">Dépôt Externe</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('cashier.external.deposit')}}" method="POST">
                                @csrf
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-6 mt-4">
                                    ...
                                    <input class="form-control input-air-primary @error('senderFirstname') is-invalid @enderror" name="senderFirstname" id="senderFirstname" type="text" required="">
                                  ...
                                  <div class="col-md-6 mt-4">
                                    ...
                                    <input class="form-control input-air-primary @error('senderLastname') is-invalid @enderror" name="senderLastname" id="senderLastname" type="text" required="">
                                  ...
                                  <div class="col-md-6 mt-4">
                                    <label class="form-label" for="validationCustom01">Numéro de l'Expéditeur</label>
                                    <input class="form-control input-air-primary @error('sender_number') is-invalid @enderror" name="sender_number" id="sender_number" type="text" required="">
                                    @error('sender_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
