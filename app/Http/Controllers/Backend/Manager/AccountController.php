...
class AccountController extends Controller
{
    ...
    public function pret($id)
    {
        ...
        return view('backend.manager.operation.pret', $data);
    }
    ...
    public function client($id)
    {
        ...
        $data['pret'] = $pret;
        return view('backend.manager.customer.account', $data);
    }
    ...
    public function client_depot($id){
        ...
        $response = new CustomerController();
        $data = $response->getCustomerData($id);
        return view('backend.manager.operation.depot',$data);
    ...
    public function client_retrait($id){
        ...
        return view('backend.manager.operation.retrait',$data);
    ...
    public function client_transfert($id){
        ...
        return view('backend.manager.operation.transfert',$data);
    ...
    public function remboursement($id){
        ...
        return view('backend.manager.operation.remboursement',$data);
