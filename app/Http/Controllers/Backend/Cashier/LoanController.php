...
class LoanController extends Controller
{
    public function index()
    {
        ...
        return view('backend.cashier.loan.index',compact('loans'));
    }
    ...
    public function history($id)
    {
        ...
        return view('backend.cashier.loan.history', compact('loans'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.cashier.loan.create',compact('loans'));
    }
    ...
    public function createId($id)
    {
        ...
        return view('backend.cashier.loan.createId', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cashier.loans.index');
    ...
    public function show($id)
    {
        ...
        return view('backend.cashier.loan.show', compact('loan', 'amortizationSchedule'));
    }
