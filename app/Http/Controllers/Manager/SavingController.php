...
class SavingController extends Controller
{
    public function index(){
        ...
        if (Auth::user()->role_name == "Manager") {
            return view('manager.account.saving.list', compact('accounts','closed','report_cdf_on_c','report_usd_on_c'));
        }
        elseif (Auth::user()->role_name == "Cashier") {
            return view('cashier.account.saving.list', compact('accounts','closed','report_cdf_on_c','report_usd_on_c'));
        }
    ...
    public function verify(){
        ...
        $report_usd_on_c = $report['report_usd_on_c'];
        if (Auth::user()->role_name == "Manager") {
            return view('manager.account.saving.verify', compact('closed','report_cdf_on_c','report_usd_on_c'));
        }
        elseif (Auth::user()->role_name == "Cashier") {
            return view('cashier.account.saving.verify', compact('closed','report_cdf_on_c','report_usd_on_c'));
        }
    ...
    public function create(){
        if (Auth::user()->role_name == "Manager") {
            return view('manager.account.saving.add');
        }
        elseif (Auth::user()->role_name == "Cashier") {
            return view('cashier.account.saving.add');
        }
