...
class CashRegisterController extends Controller
{
    ...
    public function ouverture(){
        ...
        if ($branche_id == null) {
            ...
            //     'success'=>false,
            //     'message' => "La dernière session n'a pas été clôturée, voudriez-vous la clôturer ou continuer?"
            // ]);
            return view('backend.branche.ouverture', 
    ...
    public function cloture(){
        ...
        if ($branche_id == null) {
            ...
            $dateOuverture  = $getLastOpenedRegisterFc->closing_date;
            ...
            $solde_theorique_cdf = ($dernierSoldeFc + $credit_cdf) - $debit_cdf;
            $solde_theorique_usd = ($dernierSoldeUs + $credit_usd) - $debit_usd;

            return view('backend.branche.cloture', 
            compact('transactions','todayDate','account_cdf','account_usd',
            'authorization','credit_cdf','debit_cdf','credit_usd','debit_usd','total_trx'
            ,'total_credit','total_debit','fees_cdf','fees_usd','agence_cdf','agence_usd',
            'dateCloture','dateOuverture','dernierSoldeFc','dernierSoldeUs','solde_theorique_usd',
            'solde_theorique_cdf','IDdernierSoldeFc','IDdernierSoldeUs'
            ));
    }
