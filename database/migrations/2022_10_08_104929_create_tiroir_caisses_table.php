...
class CreateTiroirCaissesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tiroir_caisses', function (Blueprint $table) {
            $table->id();
            ...
            $table->bigInteger('cash_register')->unsigned()->nullable();
            $table->decimal('balance',10,2)->default(0.00);
            $table->string('currency')->nullable();
            $table->tinyInteger('status')->nullable()->comment('1=> Active, 2 => Not Active, 3 => Blocked');
            $table->foreign('cash_register')->references('id')->on('cash_registers');
    ...
    {
        Schema::dropIfExists('tiroir_caisses');
    }
}
